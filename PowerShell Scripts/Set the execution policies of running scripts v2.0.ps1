...
`nYes --> Enter 'Y' to continune setting the execution policy to your choice.
`nQuit--> Enter 'Q' to quit this script.
`nPlease select an option"
switch($var){
    Y{
	$UserInput = read-host -Prompt "
	`nEnter one of the specified policies(Restricted, AllSingned, RemoteSigned, Unrestricted, Bypass) to set the execution policy to your choice.
